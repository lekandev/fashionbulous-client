    ...
    <div className={styles.footer}>
      <div className={footer__nav}>
        ...
        <ul className={footer__contact}>
          ...
          <li className={styles.footer__contact - links}>
            fashionbulous@gmail.com
          </li>
          <li className={styles.footer__contact - links}>09022754920</li>
          <li className={styles.footer__contact - links}>
            face A, madho road, suya avenue
          </li>
        </ul>
      </div>
      <div className={footer__copyright}>
        <p className={footer__copyright - info}>
          Copyright &copy; 2021 Fashionbulous, All rights reserved, developed y{" "}
          <a href="https://lekan.vercel.app">lekandev</a>
        </p>
      </div>
    </div>
  );
